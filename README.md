...
1. ### Генератор данных (Python)
   ...
   - Значения для фитнес-трекера: шаги, пульс, калории, тип активности
   - Поддержка 10 пользователей с устойчивым поведением (с вероятностью 3% изменяется активность после минимум 10 секунд)
   - Количество калорий расчитывается из типа активности
